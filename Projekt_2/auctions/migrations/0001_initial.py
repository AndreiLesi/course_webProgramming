# Generated by Django 3.1 on 2020-08-18 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Fashion', 'Fashion'), ('Health', 'Health'), ('Technology', 'Technology'), ('Furniture', 'Furniture'), ('Other', 'Other')], max_length=64)),
                ('currentPrice', models.IntegerField(blank=True, null=True)),
                ('createdAt', models.DateField(auto_now_add=True)),
                ('createdBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bids', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='user',
