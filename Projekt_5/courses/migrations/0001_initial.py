    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.CharField(choices=[('Programming', 'Programming'), ('Business', 'Business'), ('Finance', 'Finance'), ('Design', 'Design'), ('Fotografie', 'Fotografie'), ('Marketing', 'Marketing')], max_length=70)),
        ...
        migrations.AddField(
            model_name='user',
            name='likes',
            field=models.ManyToManyField(blank=True, related_name='likes', to='courses.Course'),
        ),
        migrations.AddField(
            model_name='user',
