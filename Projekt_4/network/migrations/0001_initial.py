# Generated by Django 3.1.1 on 2020-09-19 18:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follows', models.ManyToManyField(blank=True, default=0, related_name='followers', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, default=0, related_name='likedComments', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='user',
            name='likes',
            field=models.ManyToManyField(blank=True, related_name='isLiked', to='network.Post'),
        ),
        migrations.AddField(
            model_name='user',
